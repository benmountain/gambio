...
define('EASYMARKETING_INFO_HEADING', '&Uuml;bersicht');
define('EASYMARKETING_SETTINGS_HEADING', 'Konfiguration');
define('EASYMARKETING_INSTALL', 'Easymarketing installieren.<br/><br/>');
