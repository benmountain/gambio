...
(
	...
	'status_title' => 'Modul aktiviert',
	'status_desc' => '',
	'api_token_title' => 'API Token',
	'api_token_desc' => 'Diesen Token erhalten Sie von Easymarketing.',
	'root_category_title' => 'Root-Kategorie',
	'root_category_desc' => 'Es werden nur Daten an Easymarketing übermittelt => welche unterhalb der ausgewählten Kategorie liegen.',
	'root_category_default_title' => 'Alle Kategorien vom Shop verwenden',
	'activate_google_tracking_title' => 'Google Tracking aktivieren',
	'activate_google_tracking_desc' => 'Ist dies aktiviert => so werden die Google Trackingpixel im Webshop implementiert.',
	'activate_facebook_tracking_title' => 'Facebook Tracking aktivieren',
	'activate_facebook_tracking_desc' => 'Ist dies aktiviert => so werden die Facebook Trackingpixel im Webshop implementiert.',
	'activate_remarketing_title' => 'Remarketing aktivieren',
	'activate_remarketing_desc' => 'Ist dies aktiviert => so wird Remarketing verwendet.',
	'products_description_default_title' => 'Standard Produktbeschreibung',
	'products_description_default_desc' => 'Existiert für die Produktbeschreibung kein Mapping => wird die ausgewählte Produktbeschreibung verwendet.
	...
	'condition_default_desc' => 'Dieser Zustand wird verwendet => wenn der Zustand beim Artikel nicht gepflegt ist.',
	'gender_default_title' => 'Geschlecht',
	'gender_default_desc' => 'Dieses Geschlecht wird verwendet => wenn das Geschlecht beim Artikel nicht gepflegt ist.',
	'age_group_default_title' => 'Altersgruppe',
	'age_group_default_desc' => 'Diese Altersgruppe wird verwendet => wenn die Altersgruppe beim Artikel nicht gepflegt ist.',
	'availability_stock_0_title' => 'Verfügbarkeit - Lagerbestand < 1',
	'availability_stock_0_desc' => 'Bitte geben sie die Verfügbarkeit der Artikel an => welche im Shop einen negativen Lagerbestand oder einen Lagerbestand von 0 haben',
	'availability_stock_1_title' => 'Verfügbarkeit - Lagerbestand > 0',
	'availability_stock_1_desc' => 'MODULE_EM_Bitte geben sie die Verfügbarkeit der Artikel an => welche im Shop einen positiven Lagerbestand haben',
	'shipping_countries_title' => 'Lieferländer',
	'shipping_countries_desc' => 'Bitte tragen Sie hier die ISO-Codes der Lieferländer kommagetrennt ein => für welche Versandkosten berechnet werden sollen. (z.B. DE =>AT =>CH)',
	...
	'mappings_field_name_desc' => 'Falls kein Mapping existiert, wird standardmäßig der Produktname verwendet.',
	'mappings_field_description_desc' => 'Falls kein Mapping existiert, wird standardmäßig die kurze Produktbeschreibung, ansonsten die normale Produktbeschreibung verwendet falls die kurze Produktbeschreibung nicht existiert.'
);
