...
(
	...
	'status_title' => 'Modul active',
	'status_desc' => '',
	'api_token_title' => 'API Token',
	'api_token_desc' => 'MODULE_EM_This token you get from easymarketing.',
	'root_category_title' => 'Root-category',
	'root_category_desc' => 'It is only transmitted data to Easymarketing, which are below the selected category.',
	'root_category_default_title' => 'Use all categories of this shop',
	'activate_google_tracking_title' => 'Activate Google Tracking',
	'activate_google_tracking_desc' => 'If this is activated, the Google trackingpixel are implemented in the webshop.',
	'activate_facebook_tracking_title' => 'Activate Facebook Tracking',
	'activate_facebook_tracking_desc' => 'If this is activated, the Facebook trackingpixel are implemented in the webshop.',
	'activate_remarketing_title' => 'Remarketing - activate',
	'activate_remarketing_desc' => 'If this is activated, remarketing is used.',
	'products_description_default_title' => 'Default products description for Google',
	'products_description_default_desc' => 'If there is no mapping of the product description, the selected product description is used.
	...
	'condition_default_desc' => 'Please choose a condition for your products.',
	'gender_default_title' => 'Gender',
	'gender_default_desc' => 'This gender is used when the gender is not maintained in the article.',
	'age_group_default_title' => 'Age group',
	'age_group_default_desc' => 'This age group is used when the age group is not maintained in the article.',
	'availability_stock_0_title' => 'availability - stock < 1',
	'availability_stock_0_desc' => 'Please choose the availability for products with stock smaller 0',
	'availability_stock_1_title' => 'availability - stock > 0',
	'availability_stock_1_desc' => 'Please choose the availability for products with stock more than 0',
	'shipping_countries_title' => 'Countries of Delivery',
	'shipping_countries_desc' => 'Please enter the ISO codes for the countries for which you want to calculate the shipping costs. (for example: DE, AT, CH)',
	...
	'mappings_field_name_desc' => 'If no mapping exists, the product name is used by default.',
	'mappings_field_description_desc' => 'If no mapping exists, the short product description is used, otherwise the normal product description is used.'
);